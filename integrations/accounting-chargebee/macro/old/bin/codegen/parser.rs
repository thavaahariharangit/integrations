...
pub(crate) fn enum_names(urls: Vec<String>) -> Result<Vec<String>> {
    return Ok(vec![]);
}

pub(crate) fn model_names(urls: Vec<String>) -> Result<Vec<String>> {
    return Ok(vec![]);
}
...
pub(crate) fn parse(urls: Vec<String>) -> Result<(Vec<APIModel>, Vec<APIEnum>)> {
